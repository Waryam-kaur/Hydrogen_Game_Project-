...
levels = [
    {'name': "Edmonton", 'coins': 5, 'fuel_cells': 2, 'background': "Background5.JPG", 'car_image': "image.png"},
    {'name': "Red Deer", 'coins': 5, 'fuel_cells': 2, 'background': "Mountain.png", 'car_image': "car_image.png"},
    {'name': "Calgary", 'coins': 5, 'fuel_cells': 2, 'background': "Calgary.png", 'car_image': "large_truck.png"},
    {'name': "Revelstoke", 'coins': 5, 'fuel_cells': 2, 'background': "Revelstoke.png", 'car_image': "logging_truck.png"},
    {'name': "Vancouver", 'coins': 5, 'fuel_cells': 3, 'background': "Vancouver.png", 'car_image': "Boat_image.png"},
]
...
def spawn_fuel_cells(num_fuel_cells):
    return [FuelCell(random.randint(0, SCREEN_WIDTH - FUEL_CELL_WIDTH),
...
5 Hydrogen Fuel station were created,
Occupying 1000 each.
Thank you for playing!"""
    else:
        message = f"""Congratulations! You created a fuel station in {level["name"]}!
Upgraded to next level.
Here’s your upgraded vehicle:"""
    ...
    while running:
        ...
        for i in range(len(coins) - 1, -1, -1):
            ...
            if car_rect.colliderect(coin):  # Check if the car collects the coin
                ...
                new_coin = pygame.Rect(random.randint(0, SCREEN_WIDTH - COIN_WIDTH),
        ...
        for i in range(len(fuel_cells) - 1, -1, -1):
            ...
            if car_rect.colliderect(fuel_cell.rect):  # Check if the car collects the fuel cell
                ...
                new_fuel_cell = FuelCell(random.randint(0, SCREEN_WIDTH - FUEL_CELL_WIDTH),
                                          random.randint(ROAD_TOP + 10, ROAD_BOTTOM - FUEL_CELL_HEIGHT - 10))
